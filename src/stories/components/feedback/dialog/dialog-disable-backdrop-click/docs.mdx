...
import DialogDisableBackdropClick from './index';

<Title>Dialog Disable Backdrop Click</Title>

<Subtitle>
If true, clicking the backdrop dialog will not fire the onClose callback.
</Subtitle>

...
import DialogFullScreen from './index';

<Title>Dialog Full Screen</Title>

<Subtitle>
You can set a dialog to full screen.
</Subtitle>
...
const DialogDemo = () => {
  ...
  return (
    <div>
      ...
      <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open} fullScreen="true">
